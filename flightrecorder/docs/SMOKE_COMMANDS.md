...
| `tests/smoke/smoke_junior_tasks.py` | `.venv/bin/python tests/smoke/smoke_junior_tasks.py` |
...
| `tests/smoke/smoke_search_api.py` | `.venv/bin/python tests/smoke/smoke_search_api.py` |
